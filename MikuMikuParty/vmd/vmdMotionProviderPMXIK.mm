...
//
void vmdMotionProviderPMX::resolveIK()
{
...
void vmdMotionProviderPMX::makeQuaternion(float* quat, float angle, PVRTVec3 axis )
{
...
void vmdMotionProviderPMX::clearUpdateFlags( int32_t iCurrentBone, int32_t iTargetBone )
{
...
void vmdMotionProviderPMX::ccdIK( ik_item* pIK)
{
